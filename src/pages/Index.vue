  ...
  <div>
    <div class="page-header clear-filter" filter-color="orange">
      <parallax
        ...
        style="background-image:url('img/big_data.png')"
      >
      </parallax>
      <div class="container">
        <div class="content-center brand">
          <img class="n-logo" src="img/gab_logo.svg" alt="" />
          <h1 class="h1-seo">Gabinete Produtivo.</h1>
          <h3>O jeito mais fácil de você tomar decisões</h3>
        </div>
